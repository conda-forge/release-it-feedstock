...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/release-it-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/release-it-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install release-it
```
...
It is possible to list all of the versions of `release-it` available on your platform:
...
```
pixi search release-it --channel conda-forge
```
